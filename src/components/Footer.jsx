        ...
        <section className="footer container">
            ...
            <div className="common-footer-container">
                ...
                <ul className="footer-ul">
                    <li className="footer-li"><a href="" className="footer-links">About Us</a></li>
                    <li className="footer-li"><a href="" className="footer-links">Contact</a></li>
                    <li className="footer-li"><a href="" className="footer-links">Blog</a></li>
                </ul>
            ...
            <div className="common-footer-container">
                ...
                <ul className="footer-ul">
                    <li className="footer-li"><a href="" className="footer-links">Careers</a></li>
                    <li className="footer-li"><a href="" className="footer-links">Support</a></li>
                    <li className="footer-li"><a href="" className="footer-links">Privacy Policy</a></li>
                </ul>

            </div>
            <div className="common-footer-container footer-btn-container">
